...
from .f_nspkg import FNspkgModelConfig


fnspkg_method = MethodSpecification(
    ...
    description="F_Nspkg NeRF model for static scenes"
)

fnspkg_dynamic_method = MethodSpecification(
    config=TrainerConfig(
        method_name="fnspkg-dynamic",
        steps_per_eval_batch=500,
        steps_per_save=2000,
        steps_per_eval_all_images=30000,
        max_num_iterations=30001,
    ...
    description="F_Nspkg NeRF model for dynamic scenes"
)
